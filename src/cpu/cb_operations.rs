...
pub fn build_cb_instructions<M: MemoryMapper>() -> Vec<Instruction<M>> {
    vec![
        ...
        Instruction {
			opcode: 0x05,
			micro_ops: vec![Cpu::read_memory::<HL, Z>, Cpu::write_rlc_mem::<HL, Z>, Cpu::noop, ],
		},
        Instruction {
			opcode: 0x06,
			micro_ops: vec![Cpu::rlc::<B>],
        ...
        Instruction {
			opcode: 0x0D,
			micro_ops: vec![Cpu::read_memory::<HL, Z>, Cpu::write_rrc_mem::<HL, Z>, Cpu::noop, ],
		},
        Instruction {
			opcode: 0x0E,
			micro_ops: vec![Cpu::rrc::<B>],
        ...
        Instruction {
			opcode: 0x15,
			micro_ops: vec![Cpu::read_memory::<HL, Z>, Cpu::write_rl_mem::<HL, Z>, Cpu::noop, ],
		},
        Instruction {
			opcode: 0x16,
			micro_ops: vec![Cpu::rl::<B>],
        ...
        Instruction {
			opcode: 0x1D,
			micro_ops: vec![Cpu::read_memory::<HL, Z>, Cpu::write_rr_mem::<HL, Z>, Cpu::noop, ],
		},
        Instruction {
			opcode: 0x1E,
			micro_ops: vec![Cpu::rr::<B>],
        ...
        Instruction {
			opcode: 0x25,
			micro_ops: vec![Cpu::read_memory::<HL, Z>, Cpu::write_sla_mem::<HL, Z>, Cpu::noop, ],
		},
        Instruction {
			opcode: 0x26,
			micro_ops: vec![Cpu::sla::<B>],
        ...
        Instruction {
			opcode: 0x2D,
			micro_ops: vec![Cpu::read_memory::<HL, Z>, Cpu::write_sra_mem::<HL, Z>, Cpu::noop, ],
		},
        Instruction {
			opcode: 0x2E,
			micro_ops: vec![Cpu::sra::<B>],
        ...
        Instruction {
			opcode: 0x35,
			micro_ops: vec![Cpu::read_memory::<HL, Z>, Cpu::write_swap_mem::<HL, Z>, Cpu::noop, ],
		},
        Instruction {
			opcode: 0x36,
			micro_ops: vec![Cpu::swap::<B>],
        ...
        Instruction {
			opcode: 0x3D,
			micro_ops: vec![Cpu::read_memory::<HL, Z>, Cpu::write_srl_mem::<HL, Z>, Cpu::noop, ],
		},
        Instruction {
			opcode: 0x3E,
			micro_ops: vec![Cpu::srl::<B>],
        ...
        Instruction {
			opcode: 0x86,
			micro_ops: vec![Cpu::read_memory::<HL, Z>, Cpu::write_res_mem::<0, HL, Z>, Cpu::res::<0, Z>, ],
		},
        Instruction {
			opcode: 0x87,
        ...
        Instruction {
			opcode: 0x8E,
			micro_ops: vec![Cpu::read_memory::<HL, Z>, Cpu::write_res_mem::<1, HL, Z>, Cpu::noop, ],
		},
        Instruction {
			opcode: 0x8F,
        ...
        Instruction {
			opcode: 0x96,
			micro_ops: vec![Cpu::read_memory::<HL, Z>, Cpu::write_res_mem::<2, HL, Z>, Cpu::noop, ],
		},
        Instruction {
			opcode: 0x97,
        ...
        Instruction {
			opcode: 0x9E,
			micro_ops: vec![Cpu::read_memory::<HL, Z>, Cpu::write_res_mem::<3, HL, Z>, Cpu::noop, ],
		},
        Instruction {
			opcode: 0x9F,
        ...
        Instruction {
			opcode: 0xA6,
			micro_ops: vec![Cpu::read_memory::<HL, Z>, Cpu::write_res_mem::<4, HL, Z>, Cpu::noop, ],
		},
        Instruction {
			opcode: 0xA7,
        ...
        Instruction {
			opcode: 0xAE,
			micro_ops: vec![ Cpu::read_memory::<HL, Z>, Cpu::write_res_mem::<5, HL, Z>, Cpu::noop, ],
		},
        Instruction {
			opcode: 0xAF,
        ...
        Instruction {
			opcode: 0xB6,
			micro_ops: vec![ Cpu::read_memory::<HL, Z>, Cpu::write_res_mem::<6, HL, Z>, Cpu::noop, ],
		},
        Instruction {
			opcode: 0xB7,
        ...
        Instruction {
			opcode: 0xBE,
			micro_ops: vec![ Cpu::read_memory::<HL, Z>, Cpu::write_res_mem::<7, HL, Z>, Cpu::noop, ],
		},
        Instruction {
			opcode: 0xBF,
        ...
        Instruction {
			opcode: 0xC6,
			micro_ops: vec![ Cpu::read_memory::<HL, Z>, Cpu::write_set_mem::<0, HL, Z>, Cpu::noop, ],
		},
        Instruction {
			opcode: 0xC7,
        ...
        Instruction {
			opcode: 0xCE,
			micro_ops: vec![ Cpu::read_memory::<HL, Z>, Cpu::write_set_mem::<1, HL, Z>, Cpu::noop, ],
		},
        Instruction {
			opcode: 0xCF,
        ...
        Instruction {
			opcode: 0xD6,
			micro_ops: vec![ Cpu::read_memory::<HL, Z>, Cpu::write_set_mem::<2, HL, Z>, Cpu::noop, ],
		},
        Instruction {
			opcode: 0xD7,
        ...
        Instruction {
			opcode: 0xDE,
			micro_ops: vec![ Cpu::read_memory::<HL, Z>, Cpu::write_set_mem::<3, HL, Z>, Cpu::noop, ],
		},
        Instruction {
			opcode: 0xDF,
        ...
        Instruction {
			opcode: 0xE6,
			micro_ops: vec![ Cpu::read_memory::<HL, Z>, Cpu::write_set_mem::<4, HL, Z>, Cpu::noop, ],
		},
        Instruction {
			opcode: 0xE7,
        ...
        Instruction {
			opcode: 0xEE,
			micro_ops: vec![ Cpu::read_memory::<HL, Z>, Cpu::write_set_mem::<5, HL, Z>, Cpu::noop, ],
		},
        Instruction {
			opcode: 0xEF,
        ...
        Instruction {
			opcode: 0xF6,
			micro_ops: vec![ Cpu::read_memory::<HL, Z>, Cpu::write_set_mem::<6, HL, Z>, Cpu::noop, ],
		},
        Instruction {
			opcode: 0xF7,
        ...
        Instruction {
			opcode: 0xFE,
			micro_ops: vec![ Cpu::read_memory::<HL, Z>, Cpu::write_set_mem::<7, HL, Z>, Cpu::noop, ],
		},
        Instruction {
			opcode: 0xFF,
